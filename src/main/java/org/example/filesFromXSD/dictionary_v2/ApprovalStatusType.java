 ...
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://api.vetrf.ru/schema/cdm/codelist/v2>ApprovalStatusTypeContentType">
...
@XmlType(name = "ApprovalStatusType", propOrder = {
    "value"
})
public class ApprovalStatusType {

    @XmlValue
    protected ApprovalStatusTypeContentType value;
    @XmlAttribute
     ...
     * @return
     *     possible object is
     *     {@link ApprovalStatusTypeContentType }
     *     
     */
    public ApprovalStatusTypeContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(ApprovalStatusTypeContentType value) {
        this.value = value;
    }
