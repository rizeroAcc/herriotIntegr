 ...
 * ���, ����������� ������ ����������� � �������.
 * 
 * <p>Java class for BusinessEntityStatus complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BusinessEntityStatus">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://api.vetrf.ru/schema/cdm/codelist/v2>BusinessEntityStatusContentType">
...
@XmlType(name = "BusinessEntityStatus", propOrder = {
    "value"
})
public class BusinessEntityStatus {

    @XmlValue
    protected BusinessEntityStatusContentType value;
    @XmlAttribute
     ...
     * @return
     *     possible object is
     *     {@link BusinessEntityStatusContentType }
     *     
     */
    public BusinessEntityStatusContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(BusinessEntityStatusContentType value) {
        this.value = value;
    }
