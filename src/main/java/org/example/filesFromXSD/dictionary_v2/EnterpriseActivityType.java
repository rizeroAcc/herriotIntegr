 ...
 * ��� ������������� ������������
 * 
 * <p>Java class for EnterpriseActivityType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="EnterpriseActivityType">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://api.vetrf.ru/schema/cdm/codelist/v2>EnterpriseActivityTypeContentType">
...
@XmlType(name = "EnterpriseActivityType", propOrder = {
    "value"
})
public class EnterpriseActivityType {

    @XmlValue
    protected EnterpriseActivityTypeContentType value;
    @XmlAttribute
     ...
     * @return
     *     possible object is
     *     {@link EnterpriseActivityTypeContentType }
     *     
     */
    public EnterpriseActivityTypeContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(EnterpriseActivityTypeContentType value) {
        this.value = value;
    }
