 ...
 * ���, ����������� ���� �����������.
 * 
 * <p>Java class for EnterpriseRole complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="EnterpriseRole">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://api.vetrf.ru/schema/cdm/codelist/v2>EnterpriseRoleContentType">
...
@XmlType(name = "EnterpriseRole", propOrder = {
    "value"
})
public class EnterpriseRole {

    @XmlValue
    protected EnterpriseRoleContentType value;
    @XmlAttribute
     ...
     * @return
     *     possible object is
     *     {@link EnterpriseRoleContentType }
     *     
     */
    public EnterpriseRoleContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(EnterpriseRoleContentType value) {
        this.value = value;
    }
