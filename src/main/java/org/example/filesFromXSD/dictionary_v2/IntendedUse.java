...
import org.example.filesFromXSD.codelist.IntendedUseContentType;


/**
 * ���, ����������� ���������� ������ ���������.
 * 
 * <p>Java class for IntendedUse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="IntendedUse">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://api.vetrf.ru/schema/cdm/codelist/v2>IntendedUseContentType">
...
@XmlType(name = "IntendedUse", propOrder = {
    "value"
})
public class IntendedUse {

    @XmlValue
    protected IntendedUseContentType value;
    @XmlAttribute
     ...
     * @return
     *     possible object is
     *     {@link IntendedUseContentType }
     *     
     */
    public IntendedUseContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(IntendedUseContentType value) {
        this.value = value;
    }
