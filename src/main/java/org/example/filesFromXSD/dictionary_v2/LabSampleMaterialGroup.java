 ...
 * ������ ���������� ����� ��� ������������ ������������
 * 
 * <p>Java class for LabSampleMaterialGroup complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LabSampleMaterialGroup">
 *   &lt;complexContent>
...
@XmlType(name = "LabSampleMaterialGroup", propOrder = {
    "name"
})
public class LabSampleMaterialGroup
