 ...
 * ��� ��� ������������� Packing Code � ������������ �
 *             "�� 013-2010 (���.1) - ������������� ����� �����, �������� � ����������� ����������".
 *             ��. https://eomi.eaeunion.org/ru/#/repository/nsi/173
 *          
 * 
 * <p>Java class for PackingCodeType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PackingCodeType">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://api.vetrf.ru/schema/cdm/codelist/v2>PackingCodeTypeContentType">
...
@XmlType(name = "PackingCodeType", propOrder = {
    "value"
})
public class PackingCodeType {
