...
import org.example.filesFromXSD.codelist.ResearchResultContentType;


/**
 * ��������� ������������� ������������/���
 * 
 * <p>Java class for ResearchResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ResearchResult">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://api.vetrf.ru/schema/cdm/codelist/v2>ResearchResultContentType">
...
@XmlType(name = "ResearchResult", propOrder = {
    "value"
})
public class ResearchResult {

    @XmlValue
    protected ResearchResultContentType value;
    @XmlAttribute
     ...
     * @return
     *     possible object is
     *     {@link ResearchResultContentType }
     *     
     */
    public ResearchResultContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(ResearchResultContentType value) {
        this.value = value;
    }
