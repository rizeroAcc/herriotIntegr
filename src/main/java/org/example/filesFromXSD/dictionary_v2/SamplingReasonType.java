 ...
 * ���� ��������� ��� ���������� ������������ ������������.
 * 
 * <p>Java class for SamplingReasonType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SamplingReasonType">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://api.vetrf.ru/schema/cdm/codelist/v2>SamplingReasonTypeContentType">
...
@XmlType(name = "SamplingReasonType", propOrder = {
    "value"
})
public class SamplingReasonType {

    @XmlValue
    protected SamplingReasonTypeContentType value;
    @XmlAttribute
     ...
     * @return
     *     possible object is
     *     {@link SamplingReasonTypeContentType }
     *     
     */
    public SamplingReasonTypeContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(SamplingReasonTypeContentType value) {
        this.value = value;
    }
