 ...
 * ���, ����������� ������ ������������� ������� � �������.
 * 
 * <p>Java class for SupervisedObjectStatus complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SupervisedObjectStatus">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://api.vetrf.ru/schema/cdm/codelist/v2>SupervisedObjectStatusContentType">
...
@XmlType(name = "SupervisedObjectStatus", propOrder = {
    "value"
})
public class SupervisedObjectStatus {

    @XmlValue
    protected SupervisedObjectStatusContentType value;
    @XmlAttribute
     ...
     * @return
     *     possible object is
     *     {@link SupervisedObjectStatusContentType }
     *     
     */
    public SupervisedObjectStatusContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(SupervisedObjectStatusContentType value) {
        this.value = value;
    }
