 ...
 * ����������� �������������� �������/��������
 * 
 * <p>Java class for UnmeasuredAttribute complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UnmeasuredAttribute">
 *   &lt;complexContent>
 *     &lt;extension base="{http://api.vetrf.ru/schema/cdm/dictionary/v2}AdditionalAttribute">
 *       &lt;sequence>
 *         &lt;element name="attrValue" type="{http://api.vetrf.ru/schema/cdm/base}Text" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "UnmeasuredAttribute", propOrder = {
    "attrValue"
})
