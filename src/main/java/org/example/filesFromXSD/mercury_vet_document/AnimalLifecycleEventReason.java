 ...
 * ��������� (�������) ������� � �������� ��� ������� ��������
 * 
 * <p>Java class for AnimalLifecycleEventReason complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AnimalLifecycleEventReason">
 *   &lt;complexContent>
...
@XmlType(name = "AnimalLifecycleEventReason", propOrder = {
    "name",
    "description"
})
public class AnimalLifecycleEventReason
