 ...
 * ���, ����������� ������ ��������������� �������� � �������� ��� ������ ��������.
 * 
 * <p>Java class for AnimalRegistrationList complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AnimalRegistrationList">
 *   &lt;complexContent>
...
@XmlType(name = "AnimalRegistrationList", propOrder = {
    "animalRegistration"
})
public class AnimalRegistrationList
    extends EntityList
{
