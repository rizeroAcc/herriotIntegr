 ...
 * ��������� ��������� ������� �������� ���������
 * 
 * <p>Java class for AnimalRegistrationStatusChangeReason complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AnimalRegistrationStatusChangeReason">
 *   &lt;complexContent>
...
@XmlType(name = "AnimalRegistrationStatusChangeReason", propOrder = {
    "name",
    "description"
})
public class AnimalRegistrationStatusChangeReason
