 ...
 * ��� ������� (����������, ������)
 * 
 * <p>Java class for FMPRegistryStatus complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FMPRegistryStatus">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://api.vetrf.ru/schema/cdm/codelist/v2>FMPRegistryStatusContentType">
...
@XmlType(name = "FMPRegistryStatus", propOrder = {
    "value"
})
public class FMPRegistryStatus {
