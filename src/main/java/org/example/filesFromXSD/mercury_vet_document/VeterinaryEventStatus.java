...
import org.example.filesFromXSD.codelist.VeterinaryEventStatusContentType;


/**
 * ���, ����������� ������ ������������� �����������
 * 
 * <p>Java class for VeterinaryEventStatus complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="VeterinaryEventStatus">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://api.vetrf.ru/schema/cdm/codelist/v2>VeterinaryEventStatusContentType">
...
@XmlType(name = "VeterinaryEventStatus", propOrder = {
    "value"
})
public class VeterinaryEventStatus {

    @XmlValue
    protected VeterinaryEventStatusContentType value;
    @XmlAttribute
     ...
     * @return
     *     possible object is
     *     {@link VeterinaryEventStatusContentType }
     *     
     */
    public VeterinaryEventStatusContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(VeterinaryEventStatusContentType value) {
        this.value = value;
    }
