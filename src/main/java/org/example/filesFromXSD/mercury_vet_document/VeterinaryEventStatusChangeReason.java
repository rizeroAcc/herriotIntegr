 ...
 * ��������� ��������� ������� �������� ���������
 * 
 * <p>Java class for VeterinaryEventStatusChangeReason complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="VeterinaryEventStatusChangeReason">
 *   &lt;complexContent>
...
@XmlType(name = "VeterinaryEventStatusChangeReason", propOrder = {
    "name",
    "description"
})
public class VeterinaryEventStatusChangeReason
