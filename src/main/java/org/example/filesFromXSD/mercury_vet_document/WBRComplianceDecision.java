...
import org.example.filesFromXSD.codelist.WBRComplianceDecisionContentType;


/**
 * ��� ������� � ���������� � ������������ ������ ��� �����������
 * 
 * <p>Java class for WBRComplianceDecision complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WBRComplianceDecision">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://api.vetrf.ru/schema/cdm/codelist/v2>WBRComplianceDecisionContentType">
...
@XmlType(name = "WBRComplianceDecision", propOrder = {
    "value"
})
public class WBRComplianceDecision {

    @XmlValue
    protected WBRComplianceDecisionContentType value;
    @XmlAttribute
     ...
     * @return
     *     possible object is
     *     {@link WBRComplianceDecisionContentType }
     *     
     */
    public WBRComplianceDecisionContentType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(WBRComplianceDecisionContentType value) {
        this.value = value;
    }
